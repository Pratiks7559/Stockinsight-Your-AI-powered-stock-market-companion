// components/PortfolioControls.jsx
const PortfolioControls = ({ darkMode, setDarkMode, activePortfolio, setActivePortfolio }) => {
  const portfolios = ['Main Portfolio', 'Long-Term', 'Intraday', 'Retirement'];
